...
public class ItemSummaryByMarketplace {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(marketplaceId, brand, browseClassification, color, itemClassification, itemName, manufacturer, modelNumber, packageQuantity, partNumber, size, style, websiteDisplayGroup, websiteDisplayGroupName);
  }
